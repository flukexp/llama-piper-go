...
// List of piper voices file to be downloaded
var Files = []string{
...
// Base URL for downloads piper
var URL = "https://github.com/rhasspy/piper/releases/download/v0.0.2"

// Destination folder for the voices downloaded files
var DestinationFolder = "piper/models"
